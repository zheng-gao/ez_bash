...
[2019-11-27 13:31:08][EZ-Bash][ez_test_string_arg_required][ez.argument.get][ERROR] Argument "-i" is required
...
function ez_test_string_arg_exclude {
    ...
    local unlock; unlock=$(ez.argument.get --short "-u" --long "--unlock" --arguments "${@}") || return 1
...
[2019-11-28 17:32:34][EZ-Bash][ez_test_string_arg_exclude][ez.argument.get][ERROR] "-m" and "-f" are mutually exclusive

> ez_test_string_arg_exclude -l "Test" --unlock "Test"
[2019-11-28 17:32:51][EZ-Bash][ez_test_string_arg_exclude][ez.argument.get][ERROR] "-l" and "--unlock" are mutually exclusive
```
### --choices
```bash
...
[2019-11-27 16:32:07][EZ-Bash][ez_test_string_arg_choices][ez.argument.get][ERROR] Invalid value "Americano" for argument "-i"
[2019-11-27 16:32:07][EZ-Bash][ez_test_string_arg_choices][ez.argument.get][ERROR] Please choose from [Cappuccino, Espresso, Latte] for argument "-i"
