...
function ez_self_source_option {
    ...
    if [[ -n "${all_flag}" ]]; then
        ...
        [[ -z "${quiet_flag}" ]] && >&2 echo -e "[${EZ_LOGO}][$(ez.string.format 'ForegroundYellow' 'WARNING')] Imported ${EZ_LOGO}, skipping libraries $(ez.string.format 'ForegroundYellow' $(ez.string.join ', ' ${skip_libs[@]}))"
